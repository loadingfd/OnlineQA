...
(() => {
  ...
  function pe() {
    ...
    return ue = __spreadValues(__spreadValues({ PLATFORM: r2, OS: s2, APPID: i2, DEVICEID: n2 }, he()), t2), __spreadProps(__spreadValues(__spreadValues({}, de), ue), { locale: e2, LOCALE: e2 });
  }
  ...
  var ge = class {
    ...
    callFunction(e2) {
      ...
      return this.request(__spreadProps(__spreadValues({}, this.setupRequest(t2)), { timeout: e2.timeout }));
    }
    ...
    uploadFile(_0) {
      return __async(this, arguments, function* ({ filePath: e2, cloudPath: t2, fileType: n2 = "image", cloudPathAsRealPath: s2 = false, onUploadProgress: r2, config: i2 }) {
        ...
        const a2 = (yield this.getOSSUploadOptionsFromPath({ env: o2, filename: s2 ? t2.split("/").pop() : t2, fileId: s2 ? t2 : void 0 })).result, c2 = "https://" + a2.cdnDomain + "/" + a2.ossPath, { securityToken: u2, accessKeyId: l2, signature: h2, host: d2, ossPath: p2, id: g2, policy: m2, ossCallbackUrl: y2 } = a2, _2 = { "Cache-Control": "max-age=2592000", "Content-Disposition": "attachment", OSSAccessKeyId: l2, Signature: h2, host: d2, id: g2, key: p2, policy: m2, success_action_status: 200 };
  ...
  var Ze = class {
    ...
    send(_0) {
      return __async(this, arguments, function* (e2, t2 = {}, n2 = {}) {
        const s2 = yield this.request(e2, t2, __spreadProps(__spreadValues({}, n2), { onUploadProgress: t2.onUploadProgress }));
        if ("ACCESS_TOKEN_EXPIRED" === s2.data.code && -1 === Ge.indexOf(e2)) {
          yield this.refreshAccessToken();
          const s3 = yield this.request(e2, t2, __spreadProps(__spreadValues({}, n2), { onUploadProgress: t2.onUploadProgress }));
          if (s3.data.code)
  ...
  var ct = class extends nt {
    signIn(e2, t2) {
      return __async(this, null, function* () {
        ...
        const { refreshTokenKey: n2 } = this._cache.keys, s2 = yield this._request.send("auth.signIn", { loginType: Ve.USERNAME, username: e2, password: t2, refresh_token: this._cache.getStore(n2) || "" }), { refresh_token: r2, access_token_expire: i2, access_token: o2 } = s2;
        if (r2)
  ...
  var dt = function({ fileList: e2 }, t2) {
  ...
  var pt = function({ fileList: e2 }, t2) {
  ...
  var gt = function({ name: e2, data: t2, query: n2, parse: s2, search: r2, timeout: i2 }, o2) {
    const a2 = o2 || be();
    let c2;
    try {
  ...
  var Ot = class {
    ...
    setupLocalRequest(e2) {
      return __async(this, null, function* () {
        const t2 = pe(), { token: n2 } = oe(), s2 = Object.assign({}, e2, { spaceId: this.config.spaceId, timestamp: Date.now(), clientInfo: t2, token: n2 }), { address: r2, servePort: i2 } = this.__dev__ && this.__dev__.debugInfo || {}, { address: o2 } = yield Tt(r2, i2);
  ...
  var Kt = class {
    ...
    uploadFile(_0) {
      return __async(this, arguments, function* ({ filePath: e2, cloudPath: t2 = "", fileType: n2 = "image", onUploadProgress: s2 }) {
        ...
        if (/:\/\//.test(t2))
          throw new se({ code: "INVALID_PARAM", message: "cloudPath\u4E0D\u5408\u6CD5" });
        const r2 = yield Dt({ path: "/".concat(t2.replace(/^\//, ""), "?post_url") }, this.config), { file_id: i2, upload_url: o2, form_data: a2 } = r2, c2 = a2 && a2.reduce((e3, t3) => (e3[t3.key] = t3.value, e3), {});
...
\u8BE6\u7EC6\u4FE1\u606F\uFF1A${s4}`), r3(i3);
  ...
  var { loginPage: ws, routerNeedLogin: vs, resToLogin: Is, needLoginPage: Ss, notNeedLoginPage: bs, loginPageInTabBar: ks } = function({ pages: t2 = [], subPackages: n2 = [], uniIdRouter: s2 = {}, tabBar: r2 = {} } = e) {
        ...
        return function({ fn: e3, interceptorName: t3, getCallbackArgs: n3 } = {}) {
          ...
          return __async(this, null, function* () {
            ...
            if (a2 && uni.hideLoading(), y2 && y2.token && y2.tokenExpired && (ae(y2), X(H, __spreadValues({}, y2))), g2) {
              let e3 = m2;
              if (p2 && o2) {
                e3 = (yield o2({ objectName: t2, methodName: c2, params: l2, errSubject: f2, errCode: g2, errMsg: m2 })).errMsg || m2;
              }
              if (a2)
                if ("toast" === i2.type)
  ...
  function Gs(e2) {
    return __async(this, null, function* () {
      ...
      if (!t2.debugInfo)
        return;
      const { address: n2, servePort: s2 } = t2.debugInfo, { address: r2 } = yield Tt(n2, s2);
      if (r2)
  ...
  var _sfc_main = {
    ...
    methods: {
      ...
      add(value, {
        ...
        let db = Zs.database(this.spaceInfo);
        if (action) {
          db = db.action(action);
        }
      ...
      _execRemove(id, action, success, fail, complete, needConfirm, needLoading, loadingTitle) {
        ...
        const db = Zs.database(this.spaceInfo);
  ...
  // D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/unpackage/dist/dev/.nvue/pages/list/search/search.js
  ...
  var search = /* @__PURE__ */ _export_sfc(_sfc_main2, [["render", _sfc_render2], ["styles", [_style_02]], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/pages/list/search/search.nvue"]]);
