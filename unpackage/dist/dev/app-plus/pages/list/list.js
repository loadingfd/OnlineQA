...
(() => {
  ...
  // D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/unpackage/dist/dev/.nvue/unicloud-db.js
  var import_vue = __toESM(require_vue());

  // D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/unpackage/dist/dev/.nvue/_plugin-vue_export-helper.js
  ...
  var C = b;
  var P = I('{"address":["127.0.0.1","192.168.56.1","192.168.56.2","192.168.28.1","192.168.112.1","10.125.164.37"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","E:/HBuilderX/plugins/unicloud/**/*.js"]}');
  var T = I('[{"provider":"aliyun","spaceName":"aliyun-paid-1207","spaceId":"mp-e8352b1d-8444-493d-a46f-e61ba5b05ed4","clientSecret":"Of/aaKN7ZVRT/KSF0ltZHQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
  var O = "";
  try {
    O = "__UNI__B422D0F";
  } catch (e2) {
  ...
  var ge = class {
    ...
    uploadFile(_0) {
      return __async(this, arguments, function* ({ filePath: e2, cloudPath: t22, fileType: n2 = "image", cloudPathAsRealPath: s2 = false, onUploadProgress: r2, config: i2 }) {
        ...
        const a2 = (yield this.getOSSUploadOptionsFromPath({ env: o2, filename: s2 ? t22.split("/").pop() : t22, fileId: s2 ? t22 : void 0 })).result, c2 = "https://" + a2.cdnDomain + "/" + a2.ossPath, { securityToken: u2, accessKeyId: l2, signature: h2, host: d2, ossPath: p2, id: g2, policy: m2, ossCallbackUrl: y2 } = a2, _2 = { "Cache-Control": "max-age=2592000", "Content-Disposition": "attachment", OSSAccessKeyId: l2, Signature: h2, host: d2, id: g2, key: p2, policy: m2, success_action_status: 200 };
  ...
  var xe = { adapter: null, runtime: void 0 };
  var Oe = ["anonymousUuidKey"];
  var Ee = class extends we {
    constructor() {
      super(), xe.adapter.root.tcbObject || (xe.adapter.root.tcbObject = {});
    }
    setItem(e2, t22) {
      xe.adapter.root.tcbObject[e2] = t22;
    }
    getItem(e2) {
  ...
  function Le(e2, t22) {
    switch (e2) {
      case "local":
        return t22.localStorage || new Ee();
      case "none":
        return new Ee();
      default:
        return t22.sessionStorage || new Ee();
    }
  }
  var Re = class {
    constructor(e2) {
  ...
  var Be = "loginStateChanged";
  var We = "loginStateExpire";
  var He = "loginTypeChanged";
  var Je = "anonymousConverted";
  var ze = "refreshAccessToken";
  var Ve;
  !function(e2) {
  ...
  var Ye = { "X-SDK-Version": "1.3.5" };
  function Qe(e2, t22, n2) {
    const s2 = e2[t22];
    e2[t22] = function(t3) {
      const r2 = {}, i2 = {};
      n2.forEach((n3) => {
  ...
  function Xe() {
    ...
    return { data: { seqId: e2 }, headers: __spreadProps(__spreadValues({}, Ye), { "x-seqid": e2 }) };
  }
  var Ze = class {
    constructor(e2 = {}) {
      var t22;
      this.config = e2, this._reqClass = new xe.adapter.reqClass({ timeout: this.config.timeout, timeoutMsg: `\u8BF7\u6C42\u5728${this.config.timeout / 1e3}s\u5185\u672A\u5B8C\u6210\uFF0C\u5DF2\u4E2D\u65AD`, restrictedMethods: ["post"] }), this._cache = De(this.config.env), this._localCache = (t22 = this.config.env, Ne[t22]), Qe(this._reqClass, "post", [Xe]), Qe(this._reqClass, "upload", [Xe]), Qe(this._reqClass, "download", [Xe]);
    }
    post(e2) {
      return __async(this, null, function* () {
    ...
    _refreshAccessToken() {
      return __async(this, null, function* () {
        ...
        if (a2.data.access_token)
          return je(ze), this._cache.setStore(e2, a2.data.access_token), this._cache.setStore(t22, a2.data.access_token_expire + Date.now()), { accessToken: a2.data.access_token, accessTokenExpire: a2.data.access_token_expire };
  ...
  var it = class extends nt {
    signIn() {
      return __async(this, null, function* () {
        ...
        if (r2.uuid && r2.refresh_token) {
          this._setAnonymousUUID(r2.uuid), this.setRefreshToken(r2.refresh_token), yield this._request.refreshAccessToken(), je(Be), je(He, { env: this.config.env, loginType: Ve.ANONYMOUS, persistence: "local" });
    ...
    linkAndRetrieveDataWithTicket(e2) {
      return __async(this, null, function* () {
        ...
        if (i2.refresh_token)
          return this._clearAnonymousUUID(), this.setRefreshToken(i2.refresh_token), yield this._request.refreshAccessToken(), je(Je, { env: this.config.env }), je(He, { loginType: Ve.CUSTOM, persistence: "local" }), { credential: { refreshToken: i2.refresh_token } };
        throw new se({ message: "\u533F\u540D\u8F6C\u5316\u5931\u8D25" });
      });
    }
    _setAnonymousUUID(e2) {
      const { anonymousUuidKey: t22, loginTypeKey: n2 } = this._cache.keys;
      this._cache.removeStore(t22), this._cache.setStore(t22, e2), this._cache.setStore(n2, Ve.ANONYMOUS);
    }
    _clearAnonymousUUID() {
  ...
  var ot = class extends nt {
    signIn(e2) {
      return __async(this, null, function* () {
        ...
        if (n2.refresh_token)
          return this.setRefreshToken(n2.refresh_token), yield this._request.refreshAccessToken(), je(Be), je(He, { env: this.config.env, loginType: Ve.CUSTOM, persistence: this.config.persistence }), yield this.refreshUserInfo(), new rt(this.config.env);
  ...
  var at = class extends nt {
    signIn(e2, t22) {
      return __async(this, null, function* () {
        ...
        if (r2)
          return this.setRefreshToken(r2), i2 && o2 ? this.setAccessToken(i2, o2) : yield this._request.refreshAccessToken(), yield this.refreshUserInfo(), je(Be), je(He, { env: this.config.env, loginType: Ve.EMAIL, persistence: this.config.persistence }), new rt(this.config.env);
  ...
  var ct = class extends nt {
    signIn(e2, t22) {
      return __async(this, null, function* () {
        ...
        const { refreshTokenKey: n2 } = this._cache.keys, s2 = yield this._request.send("auth.signIn", { loginType: Ve.USERNAME, username: e2, password: t22, refresh_token: this._cache.getStore(n2) || "" }), { refresh_token: r2, access_token_expire: i2, access_token: o2 } = s2;
        if (r2)
          return this.setRefreshToken(r2), o2 && i2 ? this.setAccessToken(o2, i2) : yield this._request.refreshAccessToken(), yield this.refreshUserInfo(), je(Be), je(He, { env: this.config.env, loginType: Ve.USERNAME, persistence: this.config.persistence }), new rt(this.config.env);
  ...
  var ut = class {
    ...
    signInWithEmailAndPassword(e2, t22) {
      return __async(this, null, function* () {
        return new at(this.config).signIn(e2, t22);
      });
    }
    ...
    signOut() {
      return __async(this, null, function* () {
        ...
        return this._cache.removeStore(e2), this._cache.removeStore(t22), this._cache.removeStore(n2), je(Be), je(He, { env: this.config.env, loginType: Ve.NULL, persistence: this.config.persistence }), r2;
      });
    }
  ...
  var lt = function(e2, t22) {
    ...
    return n2.send("storage.getUploadMetadata", { path: s2 }).then((e3) => {
      ...
      n2.upload({ url: a2, data: p2, file: r2, name: s2, fileType: o2, onUploadProgress: i2 }).then((e4) => {
        201 === e4.statusCode ? t22(null, { fileID: l2, requestId: d2 }) : t22(new se({ code: "STORAGE_REQUEST_FAIL", message: `STORAGE_REQUEST_FAIL: ${e4.data}` }));
      }).catch((e4) => {
        t22(e4);
      });
    }).catch((e3) => {
  ...
  var dt = function({ fileList: e2 }, t22) {
  ...
  var ft = function(_0, _1) {
    return __async(this, arguments, function* ({ fileID: e2 }, t22) {
      const n2 = (yield pt.call(this, { fileList: [{ fileID: e2, maxAge: 600 }] })).fileList[0];
      if ("SUCCESS" !== n2.code)
  ...
  var gt = function({ name: e2, data: t22, query: n2, parse: s2, search: r2, timeout: i2 }, o2) {
    const a2 = o2 || be();
    let c2;
    try {
  ...
  var mt = { timeout: 15e3, persistence: "session" };
  var yt = {};
  var _t = class __t {
    constructor(e2) {
    ...
    init(e2) {
      switch (xe.adapter || (this.requestClient = new xe.adapter.reqClass({ timeout: e2.timeout || 5e3, timeoutMsg: `\u8BF7\u6C42\u5728${(e2.timeout || 5e3) / 1e3}s\u5185\u672A\u5B8C\u6210\uFF0C\u5DF2\u4E2D\u65AD` })), this.config = __spreadValues(__spreadValues({}, mt), e2), true) {
      ...
      return new __t(this.config);
    }
    auth({ persistence: e2 } = {}) {
      if (this.authObj)
        return this.authObj;
      const t22 = e2 || xe.adapter.primaryStorage || mt.persistence;
      var n2;
      return t22 !== this.config.persistence && (this.config.persistence = t22), function(e3) {
        const { env: t3 } = e3;
        Ue[t3] = new Re(e3), Ne[t3] = new Re(__spreadProps(__spreadValues({}, e3), { persistence: "local" }));
      }(this.config), n2 = this.config, et[n2.env] = new Ze(n2), this.authObj = new ut(this.config), this.authObj;
    }
    on(e2, t22) {
      return Ke.apply(this, [e2, t22]);
    }
    off(e2, t22) {
      return $e.apply(this, [e2, t22]);
    }
    callFunction(e2, t22) {
    ...
    useAdapters(e2) {
      const { adapter: t22, runtime: n2 } = Te(e2) || {};
      t22 && (xe.adapter = t22), n2 && (xe.runtime = n2);
    }
  };
  var wt = new _t();
  function vt(e2, t22, n2) {
    void 0 === n2 && (n2 = {});
    var s2 = /\?/.test(t22), r2 = "";
    for (var i2 in n2)
  ...
  var It = class {
    post(e2) {
      ...
      return new Promise((e3, i2) => {
        re.request({ url: vt("https:", t22), data: n2, method: "POST", header: s2, timeout: r2, success(t3) {
          e3(t3);
        }, fail(e4) {
          i2(e4);
        } });
  ...
  var Ot = class {
    ...
    setupLocalRequest(e2) {
      return __async(this, null, function* () {
        const t22 = pe(), { token: n2 } = oe(), s2 = Object.assign({}, e2, { spaceId: this.config.spaceId, timestamp: Date.now(), clientInfo: t22, token: n2 }), { address: r2, servePort: i2 } = this.__dev__ && this.__dev__.debugInfo || {}, { address: o2 } = yield Tt(r2, i2);
  ...
  var Et = { init(e2) {
    const t22 = new Ot(e2), n2 = { signInAnonymously: function() {
...
`, a3 = Se(o3, e3.secretKey).toString(Lt);
  ...
  function Nt({ url: e2, data: t22, method: n2 = "POST", headers: s2 = {}, timeout: r2 }) {
  ...
  function Dt(e2, t22) {
    const { path: n2, data: s2, method: r2 = "GET" } = e2, { url: i2, headers: o2 } = Ut(n2, { functionName: "", data: s2, method: r2, headers: { "x-alipay-cloud-mode": "oss", "x-data-api-type": "oss", "x-expire-timestamp": Date.now() + 6e4 }, signHeaderKeys: ["x-data-api-type", "x-expire-timestamp"], config: t22 });
  ...
  var Ft = class {
    ...
    signedURL(e2, t22 = {}) {
      const n2 = `/ws/function/${e2}`, s2 = this.config.wsEndpoint.replace(/^ws(s)?:\/\//, ""), r2 = Object.assign({}, t22, { accessKeyId: this.config.accessKey, signatureNonce: Rt(), timestamp: "" + Date.now() }), i2 = [n2, ["accessKeyId", "authorization", "signatureNonce", "timestamp"].sort().map(function(e3) {
  ...
  var Kt = class {
    ...
    callFunction(e2) {
      return function(e3, t22) {
        ...
        const { url: c2, headers: u2 } = Ut("/functions/invokeFunction", { functionName: n2, data: s2, method: o2, headers: a2, signHeaderKeys: ["x-to-function-name"], config: t22 });
    ...
    uploadFile(_0) {
      return __async(this, arguments, function* ({ filePath: e2, cloudPath: t22 = "", fileType: n2 = "image", onUploadProgress: s2 }) {
        ...
        if (/:\/\//.test(t22))
          throw new se({ code: "INVALID_PARAM", message: "cloudPath\u4E0D\u5408\u6CD5" });
        const r2 = yield Dt({ path: "/".concat(t22.replace(/^\//, ""), "?post_url") }, this.config), { file_id: i2, upload_url: o2, form_data: a2 } = r2, c2 = a2 && a2.reduce((e3, t3) => (e3[t3.key] = t3.value, e3), {});
      ...
      return __async(this, arguments, function* ({ fileList: e2 }) {
        return new Promise((t22, n2) => {
          ...
          Dt({ path: "/?download_url", data: { file_list: s2 }, method: "POST" }, this.config).then((e3) => {
            ...
            t22({ fileList: n3.map((e4) => ({ fileID: Mt.call(this, e4.file_id), tempFileURL: e4.download_url })) });
          }).catch((e3) => n2(e3));
        });
      });
    }
  ...
  var Wt = [{ rule: /fc_function_not_found|FUNCTION_NOT_FOUND/, content: "\uFF0C\u4E91\u51FD\u6570[{functionName}]\u5728\u4E91\u7AEF\u4E0D\u5B58\u5728\uFF0C\u8BF7\u68C0\u67E5\u6B64\u4E91\u51FD\u6570\u540D\u79F0\u662F\u5426\u6B63\u786E\u4EE5\u53CA\u8BE5\u4E91\u51FD\u6570\u662F\u5426\u5DF2\u4E0A\u4F20\u5230\u670D\u52A1\u7A7A\u95F4", mode: "append" }];
  var Ht = /[\\^$.*+?()[\]{}|]/g;
  var Jt = RegExp(Ht.source);
  function zt(e2, t22, n2) {
    return e2.replace(new RegExp((s2 = t22) && Jt.test(s2) ? s2.replace(Ht, "\\$&") : s2, "g"), n2);
    var s2;
  }
  var Gt = "request";
  var Yt = "response";
  var Qt = "both";
  var Un = { code: 2e4, message: "System error" };
  var Nn = { code: 20101, message: "Invalid client" };
  function Mn(e2) {
    const { errSubject: t22, subject: n2, errCode: s2, errMsg: r2, code: i2, message: o2, cause: a2 } = e2 || {};
    return new se({ subject: t22 || n2 || "uni-secure-network", code: s2 || i2 || Un.code, message: r2 || o2, cause: a2 });
  }
  var Kn;
  ...
  var ss = class {
    ...
    _send(e2, t22) {
      ...
      if (s2.$db.push({ $method: e2, $param: ts(t22) }), S) {
  ...
  function os(e2, t22 = {}) {
    return Qn(new e2(t22), { get: (e3, t3) => es$1("db", t3) ? rs({ $method: t3 }, null, e3) : function() {
      return rs({ $method: t3, $param: ts(Array.from(arguments)) }, null, e3);
    } });
  }
  var as = class extends class {
    constructor({ uniClient: e2 = {}, isJQL: t22 = false } = {}) {
      this._uniClient = e2, this._authCallBacks = {}, this._dbCallBacks = {}, e2._isDefault && (this._dbCallBacks = R("_globalUniCloudDatabaseCallback")), t22 || (this.auth = Xn(this._authCallBacks)), this._isJQL = t22, Object.assign(this, Xn(this._dbCallBacks)), this.env = Qn({}, { get: (e3, t3) => ({ $env: t3 }) }), this.Geo = Qn({}, { get: (e3, t3) => is({ path: ["Geo"], method: t3 }) }), this.serverDate = is({ path: [], method: "serverDate" }), this.RegExp = is({ path: [], method: "RegExp" });
    }
    getCloudEnv(e2) {
    ...
    _callCloudFunction({ action: e2, command: t22, multiCommand: n2, queryList: s2 }) {
      ...
      return c2.then(() => u2.callFunction({ name: "DCloud-clientDB", type: l, data: { action: e2, command: t22, multiCommand: n2 } })).then((e3) => {
...
\u8BE6\u7EC6\u4FE1\u606F\uFF1A${s4}`), r3(i3);
  ...
  var us = "token\u8FC7\u671F\uFF0C\u8DF3\u8F6C\u767B\u5F55\u9875\u9762";
  var ls = { TOKEN_INVALID_TOKEN_EXPIRED: us, TOKEN_INVALID_INVALID_CLIENTID: cs, TOKEN_INVALID: cs, TOKEN_INVALID_WRONG_TOKEN: cs, TOKEN_INVALID_ANONYMOUS_USER: cs };
  var hs = { "uni-id-token-expired": us, "uni-id-check-token-failed": cs, "uni-id-token-not-exist": cs, "uni-id-check-device-feature-failed": cs };
  function ds(e2, t22) {
    let n2 = "";
  ...
  function ps(e2 = [], t22 = "") {
    ...
    return e2.forEach((e3) => {
      true === e3.needLogin ? n2.push(ds(t22, e3.path)) : false === e3.needLogin && s2.push(ds(t22, e3.path));
  ...
  function ys(e2 = "", t22 = {}) {
    ...
    if (!(t22 && t22.list && t22.list.length))
      return false;
    const n2 = t22.list, s2 = fs(e2);
    return n2.some((e3) => e3.pagePath === s2);
  }
  var _s = !!e.uniIdRouter;
  var { loginPage: ws, routerNeedLogin: vs, resToLogin: Is, needLoginPage: Ss, notNeedLoginPage: bs, loginPageInTabBar: ks } = function({ pages: t22 = [], subPackages: n2 = [], uniIdRouter: s2 = {}, tabBar: r2 = {} } = e) {
    const { loginPage: i2, needLogin: o2 = [], resToLogin: a2 = true } = s2, { needLoginPage: c2, notNeedLoginPage: u2 } = ps(t22), { needLoginPage: l2, notNeedLoginPage: h2 } = function(e2 = []) {
      const t3 = [], n3 = [];
      return e2.forEach((e3) => {
  ...
  function Cs(e2) {
    const t22 = fs(As(e2));
    return !(bs.indexOf(t22) > -1) && (Ss.indexOf(t22) > -1 || vs.some((t3) => function(e3, t4) {
      return new RegExp(t4).test(e3);
    }(e2, t3)));
  }
  function Ps({ redirect: e2 }) {
    const t22 = fs(e2), n2 = fs(ws);
    return ms() !== n2 && t22 !== n2;
  }
  function Ts({ api: e2, redirect: t22 } = {}) {
    if (!t22 || !Ps({ redirect: t22 }))
      return;
  ...
  function Os() {
    !function() {
      const e3 = gs(), { abortLoginPageJump: t22, autoToLoginPage: n2 } = xs({ url: e3 });
      t22 || n2 && Ts({ api: "redirectTo", redirect: e3 });
    }();
  ...
  var Ns = /^(?:[A-Za-z\d+/]{4})*?(?:[A-Za-z\d+/]{2}(?:==)?|[A-Za-z\d+/]{3}=?)?$/;
  function Ds() {
    ...
    let n2;
    try {
      n2 = JSON.parse((s2 = t22[1], decodeURIComponent(Rs(s2).split("").map(function(e3) {
  ...
  Rs = "function" != typeof atob ? function(e2) {
    ...
    for (var n2, s2, r2 = "", i2 = 0; i2 < e2.length; )
      t22 = Us.indexOf(e2.charAt(i2++)) << 18 | Us.indexOf(e2.charAt(i2++)) << 12 | (n2 = Us.indexOf(e2.charAt(i2++))) << 6 | (s2 = Us.indexOf(e2.charAt(i2++))), r2 += 64 === n2 ? String.fromCharCode(t22 >> 16 & 255) : 64 === s2 ? String.fromCharCode(t22 >> 16 & 255, t22 >> 8 & 255) : String.fromCharCode(t22 >> 16 & 255, t22 >> 8 & 255, 255 & t22);
    return r2;
  } : atob;
  var qs = n(function(e2, t22) {
        ...
        return function({ fn: e3, interceptorName: t3, getCallbackArgs: n3 } = {}) {
          return function(...s4) {
            return __async(this, null, function* () {
              ...
              let i3, o3;
              try {
                return yield F(K(t3, "invoke"), __spreadValues({}, r3)), i3 = yield e3(...s4), yield F(K(t3, "success"), __spreadProps(__spreadValues({}, r3), { result: i3 })), i3;
              } catch (e4) {
                throw o3 = e4, yield F(K(t3, "fail"), __spreadProps(__spreadValues({}, r3), { error: o3 })), o3;
              } finally {
                yield F(K(t3, "complete"), o3 ? __spreadProps(__spreadValues({}, r3), { error: o3 }) : __spreadProps(__spreadValues({}, r3), { result: i3 }));
              }
            });
          };
        }({ fn: function s4(...l2) {
          return __async(this, null, function* () {
            ...
            const d2 = { name: t22, type: u, data: { method: c2, params: l2 } };
            ...
            if (a2 && uni.hideLoading(), y2 && y2.token && y2.tokenExpired && (ae(y2), X(H, __spreadValues({}, y2))), g2) {
              let e3 = m2;
              if (p2 && o2) {
                e3 = (yield o2({ objectName: t22, methodName: c2, params: l2, errSubject: f2, errCode: g2, errMsg: m2 })).errMsg || m2;
              }
              if (a2)
                if ("toast" === i2.type)
  ...
  function Ws(e2) {
    return __async(this, null, function* () {
      const t22 = $s(this);
      return t22.initPromise || (t22.initPromise = Bs.call(this, e2).then((e3) => e3).catch((e3) => {
  ...
  function Hs(e2) {
    return function({ openid: t22, callLoginByWeixin: n2 = false } = {}) {
      return Ws.call(e2, { openid: t22, callLoginByWeixin: n2 });
    };
  }
  function Js(e2) {
    !function(e3) {
  ...
  var Vs = class extends class {
    ...
    init() {
      return Promise.all([zs("getSystemInfo")(), zs("getPushClientId")()]).then(([{ appId: e2 } = {}, { cid: t22 } = {}] = []) => {
        if (!e2)
  ...
  function Gs(e2) {
    return __async(this, null, function* () {
      ...
      if (!t22.debugInfo)
        return;
      const { address: n2, servePort: s2 } = t22.debugInfo, { address: r2 } = yield Tt(n2, s2);
      if (r2)
  ...
  var Qs = { tcb: Ct, tencent: Ct, aliyun: me, private: Et, dcloud: Et, alipay: jt };
  var Xs = new class {
    init(e2) {
      let t22 = {};
  ...
  (() => {
    ...
    let t22 = {};
    if (e2 && 1 === e2.length)
      t22 = e2[0], Xs = Xs.init(t22), Xs._isDefault = true;
    else {
  ...
  var __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$5], ["styles", [_style_0$4]], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-icons/components/uni-icons/uni-icons.vue"]]);
  ...
  var __easycom_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4], ["styles", [_style_0$3]], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-search-bar/components/uni-search-bar/uni-search-bar.vue"]]);
  ...
  var __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["styles", [_style_0$2]], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-badge/components/uni-badge/uni-badge.vue"]]);
  ...
  var __easycom_3 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["styles", [_style_0$1]], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-list/components/uni-list-item/uni-list-item.vue"]]);
  ...
  var __easycom_4 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["styles", [_style_0]], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-list/components/uni-list/uni-list.vue"]]);
  var en = {
  ...
  var __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/HBuilderX/plugins/uniapp-cli-vite/node_modules/@dcloudio/uni-components/lib/unicloud-db/unicloud-db.vue"]]);

  // D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/unpackage/dist/dev/.nvue/pages/list/list.js
  var import_vue2 = __toESM(require_vue());
  var _style_0$32 = { "refreshBox": { "": { "width": "750rpx", "height": 50, "justifyContent": "center", "alignItems": "center", "flexDirection": "row" } }, "refreshImg": { "": { "width": "55rpx", "height": "55rpx", "zIndex": 111 } }, "refreshText": { "": { "fontSize": "26rpx", "color": "#999999", "paddingLeft": "6rpx" } } };
  var _sfc_main$42 = {
    data() {
      return {
        showRefresh: false,
  ...
  function _sfc_render$42(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("refresh", {
      ...
      (0, import_vue2.createElementVNode)("view", { class: "refreshBox" }, [
        (0, import_vue2.createCommentVNode)(' \u53EF\u4EE5\u81EA\u5DF1\u6DFB\u52A0\u56FE\u7247\u8DEF\u5F84\u6216base64\u5B9E\u73B0\u56FE\u7247 <image class="refreshImg" :src="config[state].img" mode="widthFix" resize="cover"></image> '),
        (0, import_vue2.createElementVNode)(
          "u-text",
          { class: "refreshText" },
          (0, import_vue2.toDisplayString)($props.config[$data.state].text),
          1
          /* TEXT */
        )
      ])
  ...
  var __easycom_12 = /* @__PURE__ */ _export_sfc(_sfc_main$42, [["render", _sfc_render$42], ["styles", [_style_0$32]], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/components/refreshBox/refreshBox.vue"]]);
  ...
  var __easycom_22 = /* @__PURE__ */ _export_sfc(_sfc_main$32, [["render", _sfc_render$32], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-dateformat/components/uni-dateformat/uni-dateformat.vue"]]);
  ...
  var __easycom_42 = /* @__PURE__ */ _export_sfc(_sfc_main$22, [["render", _sfc_render$22], ["styles", [_style_0$22]], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/components/uni-load-state/uni-load-state.vue"]]);
  ...
  var statusBar = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["render", _sfc_render$12], ["styles", [_style_0$12]], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-nav-bar/components/uni-nav-bar/uni-status-bar.vue"]]);
  var isIos;
  ...
  var _sfc_main2 = {
    ...
    onShow() {
      return __async(this, null, function* () {
        ...
        let location2 = yield gps.getLocation({
          geocode: true
        });
        formatAppLog("log", "at pages/list/list.nvue:128", location2);
      });
    },
    methods: {
      searchClick(e2) {
      ...
      onqueryerror(e2) {
        formatAppLog("error", "at pages/list/list.nvue:165", e2);
      },
      onpullingdown(e2) {
        formatAppLog("log", "at pages/list/list.nvue:168", e2);
        this.showRefresh = true;
  ...
  function _sfc_render2(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_refreshBox = resolveEasycom((0, import_vue2.resolveDynamicComponent)("refreshBox"), __easycom_12);
      ...
      (0, import_vue2.createElementVNode)("view", { class: "pages" }, [
        ...
        (0, import_vue2.createVNode)(_component_unicloud_db, {
          ...
          default: (0, import_vue2.withCtx)(({ data, pagination, hasMore, loading, error: error2, options }) => [
            ...
            (0, import_vue2.createVNode)(_component_uni_list, {
              class: "uni-list",
              border: false,
              style: (0, import_vue2.normalizeStyle)({ height: $data.listHight })
            }, {
  ...
  var list = /* @__PURE__ */ _export_sfc(_sfc_main2, [["render", _sfc_render2], ["styles", [_style_02]], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/pages/list/list.nvue"]]);
