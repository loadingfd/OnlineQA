...
(function(vue, shared) {
  ...
  const pages = [
    ...
    {
      path: "pages/questions/add",
      style: {
        navigationBarTitleText: "新增"
      }
    },
    {
      path: "pages/questions/edit",
      style: {
        navigationBarTitleText: "编辑"
      }
    },
    {
      path: "pages/questions/list",
      style: {
  ...
  const S = true, b$1 = "app", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C$1 = b$1, P = I('{"address":["127.0.0.1","192.168.56.1","192.168.56.2","192.168.28.1","192.168.112.1","10.125.164.37"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","E:/HBuilderX/plugins/unicloud/**/*.js"]}'), T = I('[{"provider":"aliyun","spaceName":"aliyun-paid-1207","spaceId":"mp-e8352b1d-8444-493d-a46f-e61ba5b05ed4","clientSecret":"Of/aaKN7ZVRT/KSF0ltZHQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
  let O = "";
  try {
    O = "__UNI__B422D0F";
  } catch (e2) {
  ...
  function q(e2, t2) {
    D[e2] || (D[e2] = {}), g$1(t2) && Object.keys(t2).forEach((n2) => {
      N.indexOf(n2) > -1 && function(e3, t3, n3) {
        let s2 = D[e3][t3];
        s2 || (s2 = D[e3][t3] = []), -1 === s2.indexOf(n3) && m$1(n3) && s2.push(n3);
      }(e2, n2, t2[n2]);
    });
  }
  function M(e2, t2) {
  ...
  var ge = class {
    constructor(e2) {
      ...
      }), this.config = Object.assign({}, { endpoint: 0 === e2.spaceId.indexOf("mp-") ? "https://api.next.bspapp.com" : "https://api.bspapp.com" }, e2), this.config.provider = "aliyun", this.config.requestUrl = this.config.endpoint + "/client", this.config.envType = this.config.envType || "public", this.config.accessTokenKey = "access_token_" + this.config.spaceId, this.adapter = re, this._getAccessTokenPromiseHub = new v$1({ createPromise: () => this.requestAuth(this.setupRequest({ method: "serverless.auth.user.anonymousAuthorize", params: "{}" }, "auth")).then((e3) => {
...
`, a3 = Se(o3, e3.secretKey).toString(Lt);
  ...
  async function Bt(e2 = {}) {
    ...
    return new Promise((t3, n3) => {
      re.request({ method: "POST", url: i2, data: { name: e2.name, platform: C$1, provider: s2, spaceId: r2 }, timeout: 3e3, success(e3) {
        t3(e3);
      }, fail() {
      ...
      return new Promise((t4, n4) => {
        ...
        re.request({ method: "POST", url: o2, data: { provider: s2, platform: C$1, param: r3 }, timeout: e2.timeout, success: ({ statusCode: e3, data: s3 } = {}) => !e3 || e3 >= 400 ? n4(new se({ code: s3.code || "SYS_ERR", message: s3.message || "request:fail" })) : t4({ result: s3 }), fail(e3) {
  ...
  Kn = class {
    constructor() {
      throw Mn({ message: `Platform ${C$1} is not enabled, please check whether secure network module is enabled in your manifest.json` });
    }
  };
...
详细信息：${s4}`), r3(i3);
  ...
  (() => {
    ...
    if (Object.assign(Xs, { get mixinDatacom() {
      return Ks(Xs);
    } }), Ls(Xs), Xs.addInterceptor = q, Xs.removeInterceptor = M, Xs.interceptObject = j, uni.__uniCloud = Xs, "app" === C$1) {
      const e3 = U();
  ...
  const { t: t$5 } = initVueI18n(messages$5);
  const events = {
    load: "load",
    error: "error"
  };
  ...
  const _sfc_main$10 = {
    name: "UniClouddb",
    setup(props) {
      const dataListRef = props.ssrKey ? props.getone ? shallowSsrRef(void 0, props.ssrKey) : ssrRef([], props.ssrKey) : props.getone ? shallowSsrRef(void 0, "EJvfR21dOxFNA+BxOckwqg==") : ssrRef([], "Otb8e9dwVFpYkdL6STxERg==");
    ...
    methods: {
      ...
      add(value, {
        ...
        let db2 = Zs.database(this.spaceInfo);
        if (action) {
        ...
        db2.collection(this.mainCollection).add(value).then((res) => {
          ...
          if (showToast) {
            uni.showToast({
              title: toastTitle || t$5("uniCloud.component.add.success")
            });
          }
        }).catch((err) => {
          fail && fail(err);
      ...
      remove(id, {
        ...
        uni.showModal({
          title: confirmTitle || t$5("uniCloud.component.remove.showModal.title"),
          content: confirmContent || t$5("uniCloud.component.remove.showModal.content"),
          showCancel: true,
          success: (res) => {
            if (!res.confirm) {
              return;
      ...
      update(id, value, {
        ...
        return db2.collection(this.mainCollection).doc(id).update(value).then((res) => {
          ...
          if (showToast) {
            uni.showToast({
              title: toastTitle || t$5("uniCloud.component.update.success")
            });
          }
        }).catch((err) => {
          fail && fail(err);
      ...
      _execRemove(id, action, success, fail, complete, needConfirm, needLoading, loadingTitle) {
        ...
        const db2 = Zs.database(this.spaceInfo);
  ...
  const __easycom_2$2 = /* @__PURE__ */ _export_sfc(_sfc_main$10, [["render", _sfc_render$$], ["__file", "E:/HBuilderX/plugins/uniapp-cli-vite/node_modules/@dcloudio/uni-components/lib/unicloud-db/unicloud-db.vue"]]);
  const _sfc_main$$ = {
    name: "UniGridItem",
    inject: ["grid"],
    props: {
  ...
  const __easycom_3$3 = /* @__PURE__ */ _export_sfc(_sfc_main$$, [["render", _sfc_render$_], ["__scopeId", "data-v-7a807eb7"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-grid/components/uni-grid-item/uni-grid-item.vue"]]);
  const _sfc_main$_ = {
    name: "UniGrid",
    emits: ["change"],
    props: {
  ...
  const __easycom_4$2 = /* @__PURE__ */ _export_sfc(_sfc_main$_, [["render", _sfc_render$Z], ["__scopeId", "data-v-07acefee"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-grid/components/uni-grid/uni-grid.vue"]]);
  const _sfc_main$Z = {
    name: "UniStatusBar",
    data() {
      return {
  ...
  const statusBar = /* @__PURE__ */ _export_sfc(_sfc_main$Z, [["render", _sfc_render$Y], ["__scopeId", "data-v-7920e3e0"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-nav-bar/components/uni-nav-bar/uni-status-bar.vue"]]);
  const _imports_0$5 = "/static/uni-center/headers.png";
  const _sfc_main$Y = {
    components: {
      statusBar
    },
    ...
    onShow() {
      this.hasLogin = Zs.getCurrentUserInfo().tokenExpired > Date.now();
    },
    onLoad() {
      let gridList = [];
  ...
  const PagesGridGrid = /* @__PURE__ */ _export_sfc(_sfc_main$Y, [["render", _sfc_render$X], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/pages/grid/grid.vue"]]);
  const fontData = [
    {
  ...
  const __easycom_0$c = /* @__PURE__ */ _export_sfc(_sfc_main$X, [["render", _sfc_render$W], ["__scopeId", "data-v-d31e1c47"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-icons/components/uni-icons/uni-icons.vue"]]);
  ...
  const __easycom_0$b = /* @__PURE__ */ _export_sfc(_sfc_main$W, [["render", _sfc_render$V], ["__scopeId", "data-v-26544265"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-nav-bar/components/uni-nav-bar/uni-nav-bar.vue"]]);
  ...
  const __easycom_0$a = /* @__PURE__ */ _export_sfc(_sfc_main$V, [["render", _sfc_render$U], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-dateformat/components/uni-dateformat/uni-dateformat.vue"]]);
  const _sfc_main$U = {
    name: "UniBadge",
    emits: ["click"],
    props: {
  ...
  const __easycom_1$6 = /* @__PURE__ */ _export_sfc(_sfc_main$U, [["render", _sfc_render$T], ["__scopeId", "data-v-c97cb896"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-badge/components/uni-badge/uni-badge.vue"]]);
  const _sfc_main$T = {
    name: "UniListItem",
  ...
  function _sfc_render$S(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_uni_icons = resolveEasycom(vue.resolveDynamicComponent("uni-icons"), __easycom_0$c);
    const _component_uni_badge = resolveEasycom(vue.resolveDynamicComponent("uni-badge"), __easycom_1$6);
  ...
  const __easycom_0$9 = /* @__PURE__ */ _export_sfc(_sfc_main$T, [["render", _sfc_render$S], ["__scopeId", "data-v-c7524739"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-list/components/uni-list-item/uni-list-item.vue"]]);
  const _sfc_main$S = {
    name: "uniList",
    "mp-weixin": {
      options: {
  ...
  const __easycom_1$5 = /* @__PURE__ */ _export_sfc(_sfc_main$S, [["render", _sfc_render$R], ["__scopeId", "data-v-c2f1266a"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-list/components/uni-list/uni-list.vue"]]);
  ...
  const db$a = Zs.database();
  const readNewsLog = db$a.collection("read-news-log");
  const _sfc_main$R = {
    components: {
    ...
    computed: {
      ...
      colList() {
        return [
          db$a.collection("opendb-news-articles").where(this.where).field("user_id,_id,avatar,excerpt,last_modify_date,comment_count,like_count,title,content").getTemp(),
          db$a.collection("uni-id-users").field("_id,nickname").getTemp()
        ];
      }
    },
    onLoad(event) {
    ...
    methods: {
      $log(...args) {
        formatAppLog("log", "at pages/list/detail.vue:136", "args", ...args, this.id);
      },
      setReadNewsLog() {
        let item = {
          "article_id": this.id,
        ...
        formatAppLog("log", "at pages/list/detail.vue:156", readNewsLog2);
      },
      setFavorite() {
        if (Zs.getCurrentUserInfo().tokenExpired < Date.now()) {
          return formatAppLog("log", "at pages/list/detail.vue:160", "未登录用户");
        }
        let article_id = this.id, last_time = Date.now();
        formatAppLog("log", "at pages/list/detail.vue:164", { article_id, last_time });
        readNewsLog.where(`"article_id" == "${article_id}" && "user_id"==$env.uid`).update({ last_time }).then(({ result: { updated } }) => {
          formatAppLog("log", "at pages/list/detail.vue:168", "updated", updated);
          if (!updated) {
            readNewsLog.add({ article_id }).then((e2) => {
              formatAppLog("log", "at pages/list/detail.vue:171", e2);
            }).catch((err) => {
              formatAppLog("log", "at pages/list/detail.vue:173", err);
            });
          }
        }).catch((err) => {
          formatAppLog("log", "at pages/list/detail.vue:177", err);
        });
      },
      loadData(data2) {
      ...
      shareClick() {
        ...
        formatAppLog("log", "at pages/list/detail.vue:212", JSON.stringify({
          _id,
          title,
          excerpt,
          avatar
        ...
        uniShare$2.show({
          ...
          formatAppLog("log", "at pages/list/detail.vue:285", e2);
        });
      }
    }
  };
  function _sfc_render$Q(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_uni_list = resolveEasycom(vue.resolveDynamicComponent("uni-list"), __easycom_1$5);
    const _component_unicloud_db = resolveEasycom(vue.resolveDynamicComponent("unicloud-db"), __easycom_2$2);
    return vue.openBlock(), vue.createElementBlock(
      vue.Fragment,
      null,
  ...
  const PagesListDetail = /* @__PURE__ */ _export_sfc(_sfc_main$R, [["render", _sfc_render$Q], ["__scopeId", "data-v-495067d4"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/pages/list/detail.vue"]]);
  class MPAnimation {
  ...
  const __easycom_0$8 = /* @__PURE__ */ _export_sfc(_sfc_main$Q, [["render", _sfc_render$P], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-transition/components/uni-transition/uni-transition.vue"]]);
  const _sfc_main$P = {
    name: "uniPopup",
    components: {},
  ...
  const __easycom_1$4 = /* @__PURE__ */ _export_sfc(_sfc_main$P, [["render", _sfc_render$O], ["__scopeId", "data-v-4dd3c44b"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-popup/components/uni-popup/uni-popup.vue"]]);
  const ADType = {
  ...
  const db$9 = Zs.database();
  const signInTable = db$9.action("signIn").collection("opendb-sign-in");
        ...
        if (res && res.length == 0) {
          ...
          AD.show({
            ...
            if (res2 && res2.isEnded) {
              formatAppLog("log", "at uni_modules/uni-sign-in/components/uni-sign-in/uni-sign-in.vue:106", "onClose " + res2.isEnded);
              let i2 = 0;
              uni.showLoading({
                mask: true
              });
              ...
              formatAppLog("log", "at uni_modules/uni-sign-in/components/uni-sign-in/uni-sign-in.vue:130", "onClose " + res2.isEnded);
              uni.showToast({
                title: "播放中途退出,签到失败！",
                icon: "error",
                duration: 5e3
      ...
      async open() {
        ...
        try {
          ...
          if (res && res.length == 0) {
            ...
            formatAppLog("log", "at uni_modules/uni-sign-in/components/uni-sign-in/uni-sign-in.vue:157", res2);
            uni.hideLoading();
          ...
          uni.hideLoading();
          formatAppLog("error", "at uni_modules/uni-sign-in/components/uni-sign-in/uni-sign-in.vue:177", e2);
        }
      },
      closeMe(e2) {
  ...
  const __easycom_0$7 = /* @__PURE__ */ _export_sfc(_sfc_main$O, [["render", _sfc_render$N], ["__scopeId", "data-v-dc1d9ace"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-sign-in/components/uni-sign-in/uni-sign-in.vue"]]);
  const _sfc_main$N = {
    name: "cloud-image",
    emits: ["click"],
    props: {
  ...
  const __easycom_0$6 = /* @__PURE__ */ _export_sfc(_sfc_main$N, [["render", _sfc_render$M], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/components/cloud-image/cloud-image.vue"]]);
  ...
  const uniIdCo$b = Zs.importObject("uni-id-co");
  const db$8 = Zs.database();
  const usersTable = db$8.collection("uni-id-users");
  ...
  const mutations = {
    ...
    async updateUserInfo(data2 = false) {
      if (data2) {
        ...
        const uniIdCo2 = Zs.importObject("uni-id-co", {
          customUI: true
        });
        try {
  ...
  const _sfc_main$M = {
    ...
    methods: {
      ...
      getScore() {
        ...
        db$7.collection("uni-id-scores").where('"user_id" == $env.uid').field("score,balance").orderBy("create_date", "desc").limit(1).get().then((res) => {
      ...
      async share() {
        let { result } = await db$7.collection("uni-id-users").where("'_id' == $cloudEnv_uid").field("my_invite_code").get();
  ...
  const PagesUcenterUcenter = /* @__PURE__ */ _export_sfc(_sfc_main$M, [["render", _sfc_render$L], ["__scopeId", "data-v-b6546e32"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/pages/ucenter/ucenter.vue"]]);
  ...
  const PagesUcenterSettingsSettings = /* @__PURE__ */ _export_sfc(_sfc_main$L, [["render", _sfc_render$K], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/pages/ucenter/settings/settings.vue"]]);
  const en$3 = {
  ...
  const __easycom_1$3 = /* @__PURE__ */ _export_sfc(_sfc_main$K, [["render", _sfc_render$J], ["__scopeId", "data-v-9245e42c"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-load-more/components/uni-load-more/uni-load-more.vue"]]);
  ...
  const __easycom_3$2 = /* @__PURE__ */ _export_sfc(_sfc_main$J, [["render", _sfc_render$I], ["__scopeId", "data-v-740c4771"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/components/uni-load-state/uni-load-state.vue"]]);
  const _sfc_main$I = {
    data() {
      return {
        isLoading: true,
  ...
  const PagesUcenterReadNewsLogReadNewsLog = /* @__PURE__ */ _export_sfc(_sfc_main$I, [["render", _sfc_render$H], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/pages/ucenter/read-news-log/read-news-log.vue"]]);
  function o(o2) {
  ...
  } }, e.errorCorrectLevel = t$2, b.errorCorrectLevel = e.errorCorrectLevel, b.Error = function(o2) {
  ...
  const __easycom_0$5 = /* @__PURE__ */ _export_sfc(_sfc_main$H, [["render", _sfc_render$G], ["__scopeId", "data-v-42fcb7aa"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/Sansnn-uQRCode/components/uqrcode/uqrcode.vue"]]);
  const uniShare = new UniShare();
  const _sfc_main$G = {
    components: {
      uqrcode: __easycom_0$5
    },
    onBackPress({ from }) {
      if (from == "backbutton") {
        this.$nextTick(function() {
  ...
  function _sfc_render$F(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_uqrcode = resolveEasycom(vue.resolveDynamicComponent("uqrcode"), __easycom_0$5);
  ...
  const PagesUcenterAboutAbout = /* @__PURE__ */ _export_sfc(_sfc_main$G, [["render", _sfc_render$F], ["__scopeId", "data-v-aa205f0f"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/pages/ucenter/about/about.vue"]]);
  ...
  const UniModulesUniUpgradeCenterAppPagesUpgradePopup = /* @__PURE__ */ _export_sfc(_sfc_main$F, [["render", _sfc_render$E], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-upgrade-center-app/pages/upgrade-popup.vue"]]);
  ...
  const PagesUcenterInviteInvite = /* @__PURE__ */ _export_sfc(_sfc_main$E, [["render", _sfc_render$D], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/pages/ucenter/invite/invite.vue"]]);
  ...
  const __easycom_1$2 = /* @__PURE__ */ _export_sfc(_sfc_main$D, [["render", _sfc_render$C], ["__scopeId", "data-v-09fd5285"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-easyinput/components/uni-easyinput/uni-easyinput.vue"]]);
  const _sfc_main$C = {
    name: "uniFormsItem",
    options: {
      virtualHost: true
  ...
  const __easycom_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$C, [["render", _sfc_render$B], ["__scopeId", "data-v-462874dd"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-forms/components/uni-forms-item/uni-forms-item.vue"]]);
  const _sfc_main$B = {
  ...
  const __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main$B, [["render", _sfc_render$A], ["__scopeId", "data-v-2f788efd"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-data-checkbox/components/uni-data-checkbox/uni-data-checkbox.vue"]]);
  ...
  const uploadImage = /* @__PURE__ */ _export_sfc(_sfc_main$A, [["render", _sfc_render$z], ["__scopeId", "data-v-bdfc07e0"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-file-picker/components/uni-file-picker/upload-image.vue"]]);
  const _sfc_main$z = {
    name: "uploadFile",
    emits: ["uploadFiles", "choose", "delFile"],
    props: {
  ...
  const uploadFile = /* @__PURE__ */ _export_sfc(_sfc_main$z, [["render", _sfc_render$y], ["__scopeId", "data-v-a54939c6"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-file-picker/components/uni-file-picker/upload-file.vue"]]);
  const _sfc_main$y = {
    name: "uniFilePicker",
    components: {
      uploadImage,
    ...
    created() {
      if (!(Zs.config && Zs.config.provider)) {
        this.noSpace = true;
        Zs.chooseAndUploadFile = chooseAndUploadFile;
      }
    ...
    methods: {
      ...
      async getTempFileURL(fileList) {
        ...
        const urls = await Zs.getTempFileURL(fileList);
  ...
  const __easycom_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$y, [["render", _sfc_render$x], ["__scopeId", "data-v-6223573f"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-file-picker/components/uni-file-picker/uni-file-picker.vue"]]);
  var pattern = {
    email: /^\S+?@\S+?\.\S+?$/,
  ...
  const __easycom_4$1 = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["render", _sfc_render$w], ["__scopeId", "data-v-9a1e3c32"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-forms/components/uni-forms/uni-forms.vue"]]);
  const validator$1 = {
    "title": {
      "rules": [
        {
  ...
  const db$6 = Zs.database();
  const dbCollectionName$2 = "questions";
  function getValidator$2(fields) {
    let result = {};
  ...
  const _sfc_main$w = {
    data() {
      ...
      return {
        ...
        rules: {
          ...getValidator$2(Object.keys(formData))
        }
      };
    },
    onReady() {
    ...
    methods: {
       ...
       */
      submitForm(value) {
        return db$6.collection(dbCollectionName$2).add(value).then((res) => {
          uni.showToast({
            icon: "none",
            title: "新增成功"
          });
          ...
          vue.createVNode(_component_uni_forms_item, {
            ...
            default: vue.withCtx(() => [
              vue.createVNode(_component_uni_easyinput, {
                ...
                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $data.formData.descrip = $event)
              }, null, 8, ["modelValue"])
            ]),
            _: 1
            /* STABLE */
          ...
          vue.createVNode(_component_uni_forms_item, {
            ...
            default: vue.withCtx(() => [
              vue.createVNode(_component_uni_data_checkbox, {
                ...
                "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $data.formData.difficulties = $event),
          ...
          vue.createVNode(_component_uni_forms_item, {
            ...
            default: vue.withCtx(() => [
              vue.createVNode(_component_uni_file_picker, {
                ...
                "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => $data.formData.images = $event)
              }, null, 8, ["modelValue"])
            ]),
            _: 1
            /* STABLE */
          ...
          vue.createVNode(_component_uni_forms_item, {
            ...
            default: vue.withCtx(() => [
              vue.createElementVNode("switch", {
                onChange: _cache[5] || (_cache[5] = ($event) => _ctx.binddata("is_stick", $event.detail.value)),
                checked: $data.formData.is_stick
              }, null, 40, ["checked"])
            ]),
            _: 1
            /* STABLE */
  ...
  const PagesQuestionsAdd = /* @__PURE__ */ _export_sfc(_sfc_main$w, [["render", _sfc_render$v], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/pages/questions/add.vue"]]);
  const db$5 = Zs.database();
  const dbCollectionName$1 = "questions";
  ...
  const _sfc_main$v = {
    ...
    methods: {
       ...
       */
      submitForm(value) {
        return db$5.collection(dbCollectionName$1).doc(this.formDataId).update(value).then((res) => {
          uni.showToast({
            icon: "none",
            title: "修改成功"
          });
      ...
      getDetail(id) {
        ...
        db$5.collection(dbCollectionName$1).doc(id).field("title,descrip,difficulties,category,images,is_stick").get().then((res) => {
          const data2 = res.result.data[0];
          if (data2) {
            this.formData = data2;
          }
  ...
  const PagesQuestionsEdit = /* @__PURE__ */ _export_sfc(_sfc_main$v, [["render", _sfc_render$u], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/pages/questions/edit.vue"]]);
  const en$1 = {
  ...
  const __easycom_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$u, [["render", _sfc_render$t], ["__scopeId", "data-v-f07ef577"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-search-bar/components/uni-search-bar/uni-search-bar.vue"]]);
  const _sfc_main$t = {
  ...
  const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["render", _sfc_render$s], ["__scopeId", "data-v-86aa1171"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-segmented-control/components/uni-segmented-control/uni-segmented-control.vue"]]);
  let platform = "other";
  const _sfc_main$s = {
    name: "UniFab",
  ...
  const __easycom_6 = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["render", _sfc_render$r], ["__scopeId", "data-v-85f34dfc"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-fab/components/uni-fab/uni-fab.vue"]]);
  const db$4 = Zs.database();
  const _sfc_main$r = {
    data() {
      return {
        loadMore: {
    ...
    created() {
      ...
      this.usersTemp = db$4.collection("uni-id-users").field("_id,nickname,avatar_file").getTemp();
    ...
    methods: {
      updateQtmp(pastTime) {
        this.questionsTemp = db$4.collection("questions").where(`time >= ${pastTime}`).field("title,time,descrip,difficulties,category,is_stick,user_id").getTemp();
      },
      handleItemClick(id) {
        uni.navigateTo({
          url: "./detail?id=" + id
      ...
      handleTimeFilterChange(e2) {
        this.timeFilter = e2.currentIndex;
        this.setTimeFilter(e2.currentIndex);
      },
      setTimeFilter(index) {
        const now = Date.now();
        const days = index === 0 ? 1 : 3;
        this.pastTime = now - days * 24 * 60 * 60 * 1e3;
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      ...
      vue.createElementVNode("view", { class: "filter-box" }, [
        vue.createVNode(_component_uni_segmented_control, {
          ...
          values: ["最近一天", "最近三天"],
          onClickItem: $options.handleTimeFilterChange
        }, null, 8, ["current", "onClickItem"])
      ]),
      vue.createVNode(_component_unicloud_db, {
        ref: "udb",
        ...
        default: vue.withCtx(({ data: data2, loading, hasMore, error: error2 }) => [
          error2 ? (vue.openBlock(), vue.createElementBlock(
            ...
            data2 && data2.length ? (vue.openBlock(), vue.createBlock(
              _component_uni_list,
              {
                key: 0,
                class: "question-list"
                          ...
                          vue.createElementVNode("view", { class: "user-info" }, [
                            vue.createElementVNode("view", { class: "avatar-container" }, [
                              ...
                              vue.createElementVNode(
                                "text",
                                { class: "nickname" },
                                vue.toDisplayString(item.user_id[0].nickname),
                                1
                                /* TEXT */
                              )
                            ])
                        ...
                        body: vue.withCtx(() => [
                          vue.createElementVNode("view", { class: "question-content" }, [
                            vue.createElementVNode("view", { class: "title-container" }, [
                              item.is_stick ? (vue.openBlock(), vue.createElementBlock("text", {
                                key: 0,
                                class: "stick-tag"
                              ...
                              vue.createElementVNode(
                                "text",
                                { class: "title" },
                                vue.toDisplayString(item.title.length > 15 ? item.title.substring(0, 15) + "..." : item.title),
                                1
                                /* TEXT */
                              )
                            ]),
                            vue.createElementVNode(
                              "text",
                              { class: "description" },
                              vue.toDisplayString(item.descrip.substring(0, 100)) + vue.toDisplayString(item.descrip.length > 100 ? "..." : ""),
                              1
                              /* TEXT */
                            ),
                            vue.createElementVNode("view", { class: "tags" }, [
                              vue.createElementVNode(
                                "text",
                                {
                                  class: vue.normalizeClass(["tag difficulty", { "easy": item.difficulties === 0, "medium": item.difficulties === 1, "hard": item.difficulties === 2 }])
                                },
                                vue.toDisplayString(item.difficulties === 0 ? "简单" : item.difficulties === 1 ? "中等" : "困难"),
                                3
                                /* TEXT, CLASS */
                              ),
                              vue.createElementVNode(
                                "text",
                                { class: "tag category" },
                                vue.toDisplayString(item.category === "math" ? "数学题" : item.category === "code" ? "编程题" : item.category === "resource" ? "求资料" : "其他"),
                                1
                                /* TEXT */
                              )
                            ])
              ...
              1024
              /* DYNAMIC_SLOTS */
            )) : !loading ? (vue.openBlock(), vue.createElementBlock("view", {
              key: 1,
              class: "error-message"
  ...
  const PagesQuestionsList = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["render", _sfc_render$q], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/pages/questions/list.vue"]]);
  const db$3 = Zs.database();
  const _sfc_main$q = {
    data() {
      return {
        queryWhere: "",
    ...
    onReady() {
      if (this._id) {
        ...
        this.question = db$3.collection("questions").where(`_id=="${this._id}"`).getTemp();
        this.usersTmp = db$3.collection("uni-id-users").field("_id,nickname,avatar_file").getTemp();
    ...
    methods: {
      ...
      async getAnswers() {
        const answers = await db$3.collection("answers").where({
      ...
      async submitAnswer() {
        ...
        await db$3.collection("answers").add({
          question_id: this._id,
      ...
      async likeAnswer(answer) {
        const dbAnswer = db$3.collection("answers").doc(answer._id);
        await dbAnswer.update({
          thumbs: db$3.command.inc(1)
        });
        answer.thumbs += 1;
      },
    ...
    return vue.openBlock(), vue.createElementBlock("view", null, [
      ...
      vue.createElementVNode("view", { class: "original-post" }, [
        vue.createVNode(_component_unicloud_db, {
          ...
          default: vue.withCtx(({ data: data2, loading, error: error2 }) => [
            error2 ? (vue.openBlock(), vue.createElementBlock(
              "view",
              { key: 0 },
              vue.toDisplayString(error2.message),
              ...
              vue.createElementVNode("view", { class: "user-info" }, [
                vue.createElementVNode("view", { class: "avatar-container" }, [
                  vue.createElementVNode("image", {
                    class: "avatar",
                    mode: "aspectFill",
                    src: data2.user_id[0].avatar_file.url
                  }, null, 8, ["src"])
                ]),
                vue.createElementVNode(
                  "text",
                  { class: "nickname" },
                  vue.toDisplayString(data2.user_id[0].nickname),
                  1
                  /* TEXT */
                )
              ]),
              vue.createElementVNode("view", { class: "question-content" }, [
                vue.createElementVNode(
                  "text",
                  { class: "title" },
                  vue.toDisplayString(data2.title),
                  1
                  /* TEXT */
                ),
                vue.createElementVNode(
                  "text",
                  { class: "description" },
                  vue.toDisplayString(data2.descrip),
                  1
                  /* TEXT */
                )
              ]),
              vue.createElementVNode("view", null, [
                (vue.openBlock(true), vue.createElementBlock(
                  vue.Fragment,
                  null,
                  vue.renderList(data2.images, (file, j2) => {
                    return vue.openBlock(), vue.createElementBlock(
                      vue.Fragment,
                      null,
                      [
                        file.fileType === "image" ? (vue.openBlock(), vue.createElementBlock("image", {
                          key: 0,
                          class: "post-image",
                          src: file.url
              ...
              vue.createElementVNode("view", { class: "tags" }, [
                vue.createElementVNode(
                  "text",
                  {
                    class: vue.normalizeClass(["tag difficulty", $options.difficultyClass(data2.difficulties)])
                  },
                  vue.toDisplayString($options.difficultyText(data2.difficulties)),
                  3
                  /* TEXT, CLASS */
                ),
                vue.createElementVNode(
                  "text",
                  { class: "tag category" },
                  vue.toDisplayString($options.categoryText(data2.category)),
                  1
                  /* TEXT */
                )
              ])
      ...
      vue.createElementVNode("view", { class: "answers-section" }, [
        vue.createElementVNode("view", { class: "answers-header" }, [
          vue.createElementVNode(
            "text",
            { class: "answers-count" },
            vue.toDisplayString($data.answersCount) + "个回答",
            1
            /* TEXT */
          ),
          vue.createElementVNode("view", { class: "sort-options" }, [
            vue.createElementVNode(
              "text",
              {
                class: vue.normalizeClass(["sort-item", $data.sortBy === "time" ? "active" : ""]),
                onClick: _cache[0] || (_cache[0] = ($event) => $options.changeSort("time"))
              },
              "最新",
              2
              /* CLASS */
            ...
            vue.createElementVNode(
              "text",
              {
                class: vue.normalizeClass(["sort-item", $data.sortBy === "thumbs" ? "active" : ""]),
                onClick: _cache[1] || (_cache[1] = ($event) => $options.changeSort("thumbs"))
              },
              "最赞",
              2
              /* CLASS */
        ...
        vue.createElementVNode("view", { class: "answer-list" }, [
          (vue.openBlock(true), vue.createElementBlock(
            vue.Fragment,
            null,
            vue.renderList($data.answers, (answer, index) => {
              return vue.openBlock(), vue.createElementBlock("view", {
                key: index,
                class: "answer-item"
              }, [
                vue.createElementVNode("view", { class: "answerer-info" }, [
                  vue.createElementVNode("image", {
                    class: "avatar",
                    mode: _ctx.scaleToFill,
                    src: answer.user.avatar
                  }, null, 8, ["mode", "src"]),
                  vue.createElementVNode(
                    "text",
                    { class: "nickname" },
                    vue.toDisplayString(answer.user.nickname),
                    1
                    /* TEXT */
                  )
                ]),
                vue.createElementVNode("view", { class: "answer-content" }, [
                  vue.createElementVNode(
                    "text",
                    { class: "answer-text" },
                    vue.toDisplayString(answer.content),
                    1
                    /* TEXT */
                  ),
                  answer.images && answer.images.length ? (vue.openBlock(), vue.createElementBlock("view", {
                    key: 0,
                    class: "answer-images"
                  }, [
                    (vue.openBlock(true), vue.createElementBlock(
                      vue.Fragment,
                      null,
                      vue.renderList(answer.images, (img, i2) => {
                ...
                vue.createElementVNode("view", { class: "answer-actions" }, [
                  vue.createElementVNode("view", {
                    class: "action-item",
                    onClick: ($event) => $options.likeAnswer(answer)
                  }, [
                    vue.createVNode(_component_uni_icons, {
                      type: "hand-up",
                      size: "20",
                    ...
                    vue.createElementVNode(
                      "text",
                      null,
                      vue.toDisplayString(answer.thumbs),
                      1
                      /* TEXT */
                    )
                  ], 8, ["onClick"]),
      ...
      vue.createElementVNode("view", { class: "footer-input" }, [
  ...
  const UniModulesUniFeedbackPagesOpendbFeedbackOpendbFeedback = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["render", _sfc_render$o], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-feedback/pages/opendb-feedback/opendb-feedback.vue"]]);
  const _sfc_main$o = {
    data() {
      return {
        isPC: false
  ...
  const __easycom_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["render", _sfc_render$n], ["__scopeId", "data-v-a428f129"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/components/uni-id-pages-avatar/uni-id-pages-avatar.vue"]]);
  const popup = {
    data() {
      return {};
    },
  ...
  const __easycom_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["render", _sfc_render$m], ["__scopeId", "data-v-d78c88b7"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-popup/components/uni-popup-dialog/uni-popup-dialog.vue"]]);
  const db$1 = Zs.database();
  db$1.collection("uni-id-users");
  const uniIdCo$a = Zs.importObject("uni-id-co");
  const _sfc_main$m = {
    emits: ["success"],
    computed: {},
    data() {
  ...
  const __easycom_5$2 = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["render", _sfc_render$l], ["__scopeId", "data-v-e0127e04"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/components/uni-id-pages-bind-mobile/uni-id-pages-bind-mobile.vue"]]);
  const uniIdCo$9 = Zs.importObject("uni-id-co");
  const _sfc_main$l = {
    computed: {
      userInfo() {
        return store.userInfo;
  ...
  const UniModulesUniIdPagesPagesUserinfoUserinfo = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render$k], ["__scopeId", "data-v-0be2f605"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/pages/userinfo/userinfo.vue"]]);
  ...
  const __easycom_4 = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render$j], ["__scopeId", "data-v-40b82fe9"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/components/uni-id-pages-agreements/uni-id-pages-agreements.vue"]]);
  ...
  const uniIdCo$8 = Zs.importObject("uni-id-co");
  ...
  const UniModulesUniIdPagesPagesUserinfoRealnameVerifyRealnameVerify = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$i], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/pages/userinfo/realname-verify/realname-verify.vue"]]);
  const _sfc_main$i = {
    computed: {
      agreements() {
        if (!config.agreements) {
  ...
  const __easycom_5$1 = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["render", _sfc_render$h], ["__scopeId", "data-v-c5c7cfa0"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/components/uni-id-pages-fab-login/uni-id-pages-fab-login.vue"]]);
  let currentWebview;
  const _sfc_main$h = {
    mixins: [mixin],
    data() {
  ...
  const UniModulesUniIdPagesPagesLoginLoginWithoutpwd = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["render", _sfc_render$g], ["__scopeId", "data-v-f1f87fcd"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/pages/login/login-withoutpwd.vue"]]);
  const _sfc_main$g = {
    props: {
      modelValue: String,
      value: String,
    ...
    methods: {
      getImageCaptcha(focus = true) {
        ...
        const uniIdCo2 = Zs.importObject("uni-captcha-co", {
          customUI: true
        });
  ...
  const __easycom_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$f], ["__scopeId", "data-v-a00179ae"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-captcha/components/uni-captcha/uni-captcha.vue"]]);
  const uniIdCo$7 = Zs.importObject("uni-id-co", {
    errorOptions: {
      type: "toast"
    }
  });
  ...
  const UniModulesUniIdPagesPagesLoginLoginWithpwd = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$e], ["__scopeId", "data-v-58ed63b0"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/pages/login/login-withpwd.vue"]]);
  const _sfc_main$e = {
    data() {
      return {};
    },
    ...
    methods: {
      ...
      nextStep() {
        uni.showModal({
          ...
          complete: (e2) => {
            if (e2.confirm) {
              const uniIdco = Zs.importObject("uni-id-co");
  ...
  const UniModulesUniIdPagesPagesUserinfoDeactivateDeactivate = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$d], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/pages/userinfo/deactivate/deactivate.vue"]]);
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$c], ["__scopeId", "data-v-64f2f318"], ["__file", "E:/HBuilderX/plugins/uniapp-cli-vite/node_modules/@dcloudio/uni-components/lib/uni-match-media/uni-match-media.vue"]]);
  ...
  const __easycom_3$1 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$b], ["__scopeId", "data-v-4b649130"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/components/uni-id-pages-sms-form/uni-id-pages-sms-form.vue"]]);
  const _sfc_main$b = {
    data() {
      return {
        focus: false
  ...
  const __easycom_5 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$a], ["__scopeId", "data-v-d021b99b"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-captcha/components/uni-popup-captcha/uni-popup-captcha.vue"]]);
  const _sfc_main$a = {
    data() {
      return {
        formData: {
  ...
  const UniModulesUniIdPagesPagesUserinfoBindMobileBindMobile = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$9], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/pages/userinfo/bind-mobile/bind-mobile.vue"]]);
  const _sfc_main$9 = {
    mixins: [mixin],
    data() {
      return {
  ...
  const UniModulesUniIdPagesPagesLoginLoginSmscode = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__scopeId", "data-v-661d78f6"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/pages/login/login-smscode.vue"]]);
  ...
  const uniIdCo$6 = Zs.importObject("uni-id-co");
  const _sfc_main$8 = {
    mixins: [mixin],
    data() {
      return {
  ...
  const UniModulesUniIdPagesPagesRegisterRegister = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/pages/register/register.vue"]]);
  const uniIdCo$5 = Zs.importObject("uni-id-co", {
    errorOptions: {
      type: "toast"
    }
  });
  ...
  const UniModulesUniIdPagesPagesRetrieveRetrieve = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/pages/retrieve/retrieve.vue"]]);
  const _sfc_main$6 = {
    onLoad({ url, title }) {
  ...
  const UniModulesUniIdPagesPagesCommonWebviewWebview = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/pages/common/webview/webview.vue"]]);
  const uniIdCo$4 = Zs.importObject("uni-id-co", {
    customUI: true
  });
  const _sfc_main$5 = {
    mixins: [mixin],
  ...
  const UniModulesUniIdPagesPagesUserinfoChangePwdChangePwd = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/pages/userinfo/change_pwd/change_pwd.vue"]]);
  ...
  const __easycom_3 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__scopeId", "data-v-bcd6b47b"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/components/uni-id-pages-email-form/uni-id-pages-email-form.vue"]]);
  const uniIdCo$3 = Zs.importObject("uni-id-co");
  const _sfc_main$3 = {
    mixins: [mixin],
    data() {
      return {
  ...
  const UniModulesUniIdPagesPagesRegisterRegisterByEmail = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/pages/register/register-by-email.vue"]]);
  const uniIdCo$2 = Zs.importObject("uni-id-co", {
    errorOptions: {
      type: "toast"
    }
  });
  ...
  const UniModulesUniIdPagesPagesRetrieveRetrieveByEmail = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/pages/retrieve/retrieve-by-email.vue"]]);
  const uniIdCo$1 = Zs.importObject("uni-id-co", {
    customUI: true
  });
  const _sfc_main$1 = {
    name: "set-pwd.vue",
  ...
  const UniModulesUniIdPagesPagesUserinfoSetPwdSetPwd = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__scopeId", "data-v-e5e1f63f"], ["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/uni_modules/uni-id-pages/pages/userinfo/set-pwd/set-pwd.vue"]]);
  ...
  __definePage("pages/questions/add", PagesQuestionsAdd);
  __definePage("pages/questions/edit", PagesQuestionsEdit);
  __definePage("pages/questions/list", PagesQuestionsList);
  __definePage("pages/questions/detail", PagesQuestionsDetail);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "D:/Users/ldfd/Document/HBuilderProjects/OnlineQA/App.vue"]]);
  const langEn = {
