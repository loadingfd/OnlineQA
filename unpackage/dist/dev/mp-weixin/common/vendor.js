...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{\n    "address": [\n        "127.0.0.1",\n        "198.18.0.1",\n        "192.168.30.183"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "E:/newfile/HBuilderX.4.24.2024072208/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), T = I('[{"provider":"aliyun","spaceName":"aliyun-paid-1207","spaceId":"mp-e8352b1d-8444-493d-a46f-e61ba5b05ed4","clientSecret":"Of/aaKN7ZVRT/KSF0ltZHQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__B422D0F";
} catch (e2) {
...
function ts(e2, t2, n2) {
  return Vn(new es$1(e2, t2, n2), { get(e3, t3) {
    let s2 = "db";
