...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return {
        a: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            b: "5c6db610-3-" + i0 + "-" + i1 + "," + ("5c6db610-2-" + i0 + "-" + i1),
            c: common_vendor.p({
            ...
            f: "5c6db610-2-" + i0 + "-" + i1 + "," + ("5c6db610-1-" + i0)
          };
        }),
        b: "5c6db610-1-" + i0 + ",5c6db610-0",
        c: "5c6db610-4-" + i0 + ",5c6db610-0",
        d: common_vendor.p({
          state: {
            data,
            pagination,
    ...
    d: common_vendor.sr("udb", "5c6db610-0"),
